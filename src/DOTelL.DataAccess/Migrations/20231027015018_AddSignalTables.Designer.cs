...
namespace DOTelL.DataAccess.Migrations
{
    ...
    [Migration("20231027015018_AddSignalTables")]
            ...
            modelBuilder.Entity("DOTelL.DataAccess.Models.Log", b =>
                {
                    ...
                    b.Property<Dictionary<string, object>>("Resource")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<Dictionary<string, object>>("ScopeAttributes")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("DOTelL.DataAccess.Models.Trace", b =>
                {
                    ...
                    b.Property<List<TraceEvent>>("Events")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<TraceLink>>("Links")
                        .HasColumnType("jsonb");
